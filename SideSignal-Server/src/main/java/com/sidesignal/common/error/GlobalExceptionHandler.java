...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> handleBusinessException(BusinessException exception, HttpServletRequest request) {
        ...
        log.warn("business_exception path={}, code={}, message={}", request.getRequestURI(), errorCode.getCode(), exception.getMessage());
    ...
    ResponseEntity<ErrorResponse> handleAuthenticationException(AuthenticationException exception, HttpServletRequest request) {
        log.warn("authentication_exception path={}, message={}", request.getRequestURI(), exception.getMessage());
        return ResponseEntity
    ...
    ResponseEntity<ErrorResponse> handleAccessDeniedException(AccessDeniedException exception, HttpServletRequest request) {
        log.warn("access_denied_exception path={}, message={}", request.getRequestURI(), exception.getMessage());
        return ResponseEntity
    ...
    ResponseEntity<ErrorResponse> handleNotFoundException(HttpServletRequest request) {
        log.debug("not_found_exception path={}", request.getRequestURI());
        return ResponseEntity
    ...
    ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        log.warn("validation_exception path={}, errors={}", request.getRequestURI(), exception.getBindingResult().getAllErrors());
